...
Usage:
    uv run python scripts/predict.py --model model.pkl --data data/raw/test.csv --output submission.csv
"""
...
def main() -> None:
    ...
    # Note: In practice, you'd need to apply the same preprocessing
    # as during training
